...
public class PassLock_Main extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PasswordBrain_v1_Main
     */
    ...
    private void initComponents() {
        ...
        searchJtextField.setToolTipText("Add ACCOUNT associated with the password you wish to find, then click the magnifying glass");
    ...
    private void getFileBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getFileBtnActionPerformed
        if(evt.getSource() == getFileBtn)
        {
            ...
            if(!(file.exists()))
                JOptionPane.showMessageDialog(null, "Click \"ADD PASSWORD\" to add a password.", "No File Found!", JOptionPane.ERROR_MESSAGE);
            else 
            {
    ...
    //if user clicks "search" button do this method - uses algorithm to search a array of 4 strings. At a givem line, return a[2] given a[0], i.e given an account (array pos 0), return password (array pos 2). The file will have n lines.
    private void findBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findBtnActionPerformed
        //SEARCH_dialogBox_v1 searchBtnDialog = new SEARCH_dialogBox_v1(this, true);
        //searchBtnDialog.setLocationRelativeTo(null);
        //searchBtnDialog.setVisible(true);

        String givenAccnt = JOptionPane.showInputDialog(null, "Enter ACCOUNT associated with password you wish to find: ","Search for a Password", JOptionPane.INFORMATION_MESSAGE); //dialog box for user enters "account"
        File file = new File("C:\\Users\\Nuno\\Documents\\my_passwords.txt");  //this is the file i want to search
